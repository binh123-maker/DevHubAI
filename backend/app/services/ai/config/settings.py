...
class AIServiceSettings(BaseModel):
    ...
    default_model: str = Field(default_factory=lambda: global_settings.ai_model or ProviderModel.resolve_model("openai"))
    ...
    def get_provider_credentials(self, provider_name: str) -> ProviderCredentials:
        ...
        resolved_mod = ProviderModel.resolve_model(provider)
        if provider == "openai":
            return ProviderCredentials(
                ...
                default_model=global_settings.ai_model or resolved_mod
            )
        elif provider == "groq":
            return ProviderCredentials(
                provider_name="groq",
            ...
            return ProviderCredentials(
                ...
                base_url=None,
                default_model=global_settings.gemini_model or resolved_mod
            )
